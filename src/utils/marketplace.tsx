...
import { FaShoppingCart, FaTag, FaStore, FaFacebook } from 'react-icons/fa';
...
export function detectMarketplaceType(url: string): MarketplaceType {
  ...
  if (lowerUrl.includes('facebook.com') || lowerUrl.includes('marketplace.facebook')) return 'facebook';
  if (lowerUrl.includes('whatnot.com')) return 'whatnot';
