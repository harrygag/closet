...
const ActionsPanel: React.FC<{
  ...
  isSyncing: boolean;
}> = ({ onSyncInventory, onRefreshStats, onManageListings, onManageSold, onViewAnalytics, isSyncing }) => (
  <Card>
    <CardHeader>
    ...
    <CardContent>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <Button onClick={onManageSold} className="bg-blue-600 hover:bg-blue-700 w-full">
        ...
        {isConnected ? (
          <>
            ...
            <ActionsPanel
              ...
              onManageListings={() => navigate('/import?platform=ebay')}
              onManageSold={() => navigate('/sales?platform=ebay')}
